EOLA Fairness Toolkit (v1.0.0)
The EOLA Fairness Toolkit implements a reproducible, fairness-aware, and explainable Learning Analytics architecture designed to operationalize equity-centered Early Warning Systems (EWS) in online higher education.
This repository provides an end-to-end, modular Python pipeline that integrates:
- Predictive modeling using ensemble tree-based classifiers
- Subgroup fairness auditing (Equal Opportunity, Equalized Odds, Demographic Parity)
